...
mv server.crt ../gRPCServer/ssl/server.crt
mv server.key ../gRPCServer/ssl/server.key

mv client.crt ../gRPCClient/ssl/client.crt
mv client.key ../gRPCClient/ssl/client.key